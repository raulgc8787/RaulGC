...
<?php if (have_comments()) : ?>
  <section id="comments">
    ...
    <ol class="commentlist">
      <?php wp_list_comments(array('callback' => 'studiofolio_comment')); ?>
    </ol>

    <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) : // are there comments to navigate through ?>
      <nav id="comments-nav" class="pager">
        <div class="previous"><?php previous_comments_link(__('&larr; Older comments', 'studiofolio')); ?></div>
        <div class="next"><?php next_comments_link(__('Newer comments &rarr;', 'studiofolio')); ?></div>
      </nav>
    ...
    <?php if (!comments_open() && !is_page() && post_type_supports(get_post_type(), 'comments')) : ?>
      <div class="alert alert-block fade in">
        <a class="close" data-dismiss="alert">&times;</a>
        <p><?php _e('Comments are closed.', 'studiofolio'); ?></p>
      </div>
    <?php endif; ?>
  </section><!-- /#comments -->
<?php endif; ?>
