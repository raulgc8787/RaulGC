			...
			<div class="inside">
				...
				<?php 
					...
					if ($gallery_mb->get_the_value('video')) { 
						...
						if ($gallery_mb->get_the_value('link')) echo $dummy_code . '<a href="'.$gallery_mb->get_the_value('link').'" class="video pushed'.$disabled.'">'.$image_code.'<div class="video link"></div></a>';
						else {
