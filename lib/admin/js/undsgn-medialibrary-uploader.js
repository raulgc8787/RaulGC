...
/*-----------------------------------------------------------------------------------*/
	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<a class="undsgn-uploaded-image" href="'+itemurl+'"><img id="image_'+imgID+'" class="undsgn-option-image" src="'+itemurl+'" alt="" /></a>';
          } else {
  ...
  }; // End undsgnMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the undsgnMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		undsgnMLU.removeFile();
		undsgnMLU.recreateFileField();
		undsgnMLU.mediaUpload();
